...
class OperatorsInJava  {
	...
	void ShiftOperator() {
		...
		*/
		...
		System.out.println(10 << 3);// 10*2^2=10*8=80
	...
	void BitwiseAndLogicalOperators() {
		...
		System.out.println(a<b && a++<c);//true || true = true
		System.out.println(a<b && a++<c);//10 because second condition is not checked
		System.out.println(a<b && a++<c);//true | true = true
		System.out.println(a<b && a++<c);//11 because second condition is checked
		...
		System.out.println("Bitwise inclusive OR"+(12^12));//1100 ^ 1100= 0000
